...
void Player::control(bool Right, bool Left, bool Down, bool Up)
{
	...
	if(xMovement != 0 && yMovement != 0) obj.move(sf::Vector2f(xMovement*speed*0.707, yMovement*speed*0.707)); //Fix diagnal movement speed issue
	else obj.move(sf::Vector2f(xMovement*speed, yMovement*speed));
